...
def test_flow_aggregate_structure():
    ...
    for window_key in ("window_3d", "window_7d"):
        win = data[window_key]
        ...
        # Invariant: Top Premium must be sorted by total_premium DESC
        ...
        for section in ("top_premium_bullish", "top_hits_bullish", "top_hits_bearish"):
...
def test_flow_aggregate_with_as_of_date():
    ...
    assert len(data["window_7d"]["top_premium_bullish"]) > 0
